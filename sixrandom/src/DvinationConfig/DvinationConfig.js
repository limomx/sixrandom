...
import {StyleSheet,View, Text,ScrollView,TouchableOpacity,RefreshControl,ListView} from 'react-native';
...
class DvinationConfig extends React.Component {
    Ymd2Jd(yy,mm,dd) {
      var days,tmp,yym1;
      yym1 = yy - 1;
      days = 1721422;
    ...
    GetInfo(cur)
    {
      ...
      var numMM = cur.info.lunarMonth
      var numDD = cur.info.lunarDate
      info.push("")
      ...
      var m = eval('jcName'+numMM)
      var jcday = m[numDD%12]
      //console.log(m)  
      info.push("")
...
var dvinationconfig = new DvinationConfig()
module.exports=dvinationconfig;  